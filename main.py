...
chrome_path = EnvironmentResolver.auto_detect_chrome()
webdriver_path = EnvironmentResolver.resolve_webdriver_path()
...
def worker_thread(category_name, search_key, suffix, worker_id, num_images=10, headless=True):
    ...
    try:
        ...
        image_scraper = GoogleImageScraper(config=config, worker_id=worker_id)
